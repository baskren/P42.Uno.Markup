...
namespace P42.Uno.Markup
{
    public static class CommandBarExtensions
    {
        ...
        public static TElement PrimaryCommands<TElement>(this TElement element, params ICommandBarElement[] elements) where TElement : ElementType
        {
            element.PrimaryCommands.Clear();
            return element.AddPrimaryCommands(elements);
        }
