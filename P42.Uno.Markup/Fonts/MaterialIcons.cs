...
namespace P42.Uno.Markup
{
    ...
    {
        public const string AssetPath = "ms-appx:///Assets/Fonts/MaterialIcons-Regular.ttf#Material Icons";

        public const string Error_Filled = "\ue000";
        public const string Error_Outline = "\ue001";
        public const string Warning_Filled = "\u0002";
        public const string Warning_Outline = "\uf083";

        public const string Info = "\ue88e";
        public const string Help_Filled = "\ue887";
        public const string Help_Outline = "\ue8fd";
        public const string Help_Square = "\uf1c0";
        public const string Contact_Support = "\ue94c";

        public const string Settings = "\ue8b8";
        public const string Search = "\ue8b6";

        public const string X_Outline = "\ue888";
        public const string Trash_Outline = "\ue92e";
        ...
        public const string AddCirlceOutline = "\ue148";
        ...
        public const string MoreHorz = "\ue5d3";
        public const string MoreHorzCircle = "\uef64";
        ...
        public const string LargeChevronRight = "\ue5e1";
        public const string LargeChevronLeft = "\ue2ea";
        ...
        public const string Filter9p = "\ue3da";
        public const string FilterAdd = "\ue03c";
        public const string FilterCheck = "\ue9b7";
        ...
        public const string ListAddCheck = "\ue065";
        public const string ListAdd = "\ue03b";
        public const string ListAddCheckCircle = "\ue7e6";
        public const string ListAddCircle = "\ue7e5";
    }
}
