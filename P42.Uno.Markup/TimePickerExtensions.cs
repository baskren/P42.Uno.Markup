...
namespace P42.Uno.Markup
{
    public static class TimePickerExtensions
    {
        ...
        public static TElement AddTimeChangedHandler<TElement>(this TElement element, System.EventHandler<TimePickerValueChangedEventArgs> handler) where TElement : ElementType
