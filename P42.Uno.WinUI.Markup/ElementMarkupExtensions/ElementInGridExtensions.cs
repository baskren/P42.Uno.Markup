...
public static class ElementInGridExtensions
{
    ...
    public static TView RowX<TView, TRow>(this TView view, TRow row) where TView :ElementType where TRow : Enum
    {
    ...
    public static TView RowX<TView, TRow>(this TView view, TRow first, TRow last) where TView :ElementType where TRow : Enum
    {
    ...
    public static TView ColumnX<TView, TColumn>(this TView view, TColumn column) where TView :ElementType where TColumn : Enum
    {
    ...
    public static TView ColumnX<TView, TColumn>(this TView view, TColumn first, TColumn last) where TView :ElementType where TColumn : Enum
    {
