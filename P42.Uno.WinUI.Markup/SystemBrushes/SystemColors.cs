...
public static class SystemColors
{
    ...
    public static void Debug()
    {
        ...
        #region Alt
        System.Diagnostics.Debug.WriteLine($"AltHigh  : {AltHigh}");
        System.Diagnostics.Debug.WriteLine($"AltLow  : {AltLow}");
        System.Diagnostics.Debug.WriteLine($"AltMedium  : {AltMedium}");
        System.Diagnostics.Debug.WriteLine($"AltMediumHigh  : {AltMediumHigh}");
        System.Diagnostics.Debug.WriteLine($"AltMediumLow  : {AltMediumLow}");
        #endregion

        #region Base
        System.Diagnostics.Debug.WriteLine($"BaseHigh  : {BaseHigh}");
        System.Diagnostics.Debug.WriteLine($"BaseLow  : {BaseLow}");
        System.Diagnostics.Debug.WriteLine($"BaseMedium  : {BaseMedium}");
        System.Diagnostics.Debug.WriteLine($"BaseMediumHigh  : {BaseMediumHigh}");
        System.Diagnostics.Debug.WriteLine($"BaseMediumLow  : {BaseMediumLow}");
        #endregion

        #region Chrome
        System.Diagnostics.Debug.WriteLine($"ChromeAltLow : {ChromeAltLow}");

        System.Diagnostics.Debug.WriteLine($"ChromeBlackHigh : {ChromeBlackHigh}");
        System.Diagnostics.Debug.WriteLine($"ChromeBlackMedium : {ChromeBlackMedium}");
        System.Diagnostics.Debug.WriteLine($"ChromeBlackMediumLow : {ChromeBlackMediumLow}");
        System.Diagnostics.Debug.WriteLine($"ChromeBlackLow : {ChromeBlackLow}");

        System.Diagnostics.Debug.WriteLine($"ChromeDisabledHigh : {ChromeDisabledHigh}");
        System.Diagnostics.Debug.WriteLine($"ChromeDisabled : {ChromeDisabledLow}");

        System.Diagnostics.Debug.WriteLine($"ChromeGray : {ChromeGray}");

        System.Diagnostics.Debug.WriteLine($"ChromeHigh : {ChromeHigh}");
        System.Diagnostics.Debug.WriteLine($"ChromeMedium : {ChromeMedium}");
        System.Diagnostics.Debug.WriteLine($"ChromeMediumLow : {ChromeMediumLow}");
        System.Diagnostics.Debug.WriteLine($"ChromeLow : {ChromeLow}");

        System.Diagnostics.Debug.WriteLine($"ChromeWhite : {ChromeWhite}");
        #endregion

        #region List
        System.Diagnostics.Debug.WriteLine($"ListLow : {ListLow}");
        System.Diagnostics.Debug.WriteLine($"ListMedium : {ListMedium}");
